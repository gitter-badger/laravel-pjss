...
class ListenerBackendMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:pjss-listener-backend {namespace} {name}';
    ...
    {
        return __DIR__ . '/stubs/listener-backend.stub';
    }
    ...
    {
        return $rootNamespace . '\Listeners\Backend' . '\\' . $this->getNamespaceInput() . '\\' . $this->getNameInput();
    }
