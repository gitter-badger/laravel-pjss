...
class RepositoryFrontendMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:pjss-repository-frontend {namespace} {name}';
    ...
    {
        return __DIR__ . '/stubs/repository-contract-frontend.stub';
    }
