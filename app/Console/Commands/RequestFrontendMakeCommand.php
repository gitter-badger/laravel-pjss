...
class RequestFrontendMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:pjss-request-frontend {namespace} {name} {type}';
    ...
    {
        return __DIR__ . '/stubs/request-frontend.stub';
    }
    ...
    {
        return $rootNamespace . '\Http\Requests\Frontend' . '\\' . $this->getNamespaceInput() . '\\' . $this->getNameInput();
    }
