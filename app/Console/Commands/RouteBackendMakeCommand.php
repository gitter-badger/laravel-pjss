...
class RouteBackendMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:pjss-route-backend {namespace} {name}';
    ...
    {
        return __DIR__ . '/stubs/route-backend.stub';
    }
    ...
    {
        return $rootNamespace . '\Http\Routes\Backend\\';
    }
