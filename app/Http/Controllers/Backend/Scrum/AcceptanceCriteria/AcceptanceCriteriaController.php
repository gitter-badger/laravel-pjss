...
class AcceptanceCriteriaController extends Controller
{
    ...
    public function index(ManageAcceptanceCriteriaRequest $request)
    {
        ...
        return view('backend.scrum.acceptancecriteria.index')
        	->withAcceptanceCriterias($acceptance_criterias);
    }
    ...
    {
        return view('backend.scrum.acceptancecriteria.detail')
    ...
    {
        return view('backend.scrum.acceptancecriteria.edit')
            ->withAcceptanceCriteria($acceptancecriteria);
    }
