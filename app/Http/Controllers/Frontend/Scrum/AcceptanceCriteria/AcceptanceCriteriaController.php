...
class AcceptanceCriteriaController extends Controller
{
    ...
    public function index(ManageAcceptanceCriteriaRequest $request)
    {
        ...
        return view('frontend.scrum.acceptancecriteria.index')->withAcceptanceCriterias($this->acceptancecriterias);
    }
    ...
    {
        return view('frontend.scrum.acceptancecriteria.detail')->withAcceptanceCriteria($acceptancecriteria);
    }
    ...
    {
        return view('frontend.scrum.acceptancecriteria.edit')->withAcceptanceCriteria($acceptancecriteria);
    }
