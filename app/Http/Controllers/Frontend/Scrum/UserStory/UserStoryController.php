...
class UserStoryController extends Controller
{
    ...
    public function index(ManageUserStoryRequest $request)
    {
        ...
        return view('frontend.scrum.userstory.index')->withUserStories($this->userstories);
    }
    ...
    {
        $this->userstories->create($request);
    ...
    {
        return view('frontend.scrum.userstory.detail')->withUserStory($userstory);
    }
    ...
    {
        return view('frontend.scrum.userstory.edit')->withUserStory($userstory);
    }
    ...
    {
        $this->userstories->update($userstory, $request);
