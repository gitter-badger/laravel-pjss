...
Route::group([
    ...
    Route::group([
        ...
        Route::post('userstory/import/excel', 'UserStoryController@importExcel')->name('admin.scrum.userstory.import_excel');
        Route::get('userstory/export/excel', 'UserStoryController@exportExcel')->name('admin.scrum.userstory.export_excel');
