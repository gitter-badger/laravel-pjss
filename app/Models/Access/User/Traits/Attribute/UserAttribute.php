...
trait UserAttribute
{
    ...
    public function getLoginAsButtonAttribute()
    {
        ...
        if (! session()->has("admin_user_id") || ! session()->has("temp_user_id")) {
            ...
            if ($this->id != access()->id()) {
                return '<a href="' . route('admin.access.user.login-as', $this) . '" class="btn btn-xs btn-success"><i class="fa fa-lock" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.backend.access.users.login_as', [
                    'user' => $this->name
                ]) . '"></i></a> ';
            }
        }
    ...
    public function getActionButtonsAttribute()
    {
        ...
        return $this->getLoginAsButtonAttribute() . $this->getEditButtonAttribute() . $this->getChangePasswordButtonAttribute() . $this->getStatusButtonAttribute() . $this->getConfirmedButtonAttribute() . $this->getDeleteButtonAttribute();
    }
}
