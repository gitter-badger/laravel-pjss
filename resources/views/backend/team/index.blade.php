		...
		<div class="col-lg-4">
			<div class="ibox">
				...
				<div class="ibox-content">
					<div class="team-members">
						<a href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a1.jpg"></a> <a href="teams_board.html#"><img
							alt="member" class="img-circle" src="img/a2.jpg"></a> <a
							href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a3.jpg"></a> <a href="teams_board.html#"><img
							alt="member" class="img-circle" src="img/a5.jpg"></a> <a
							href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a6.jpg"></a>
					</div>
					...
					<p>It is a long established fact that a reader will be distracted
						...
						point of using Lorem Ipsum is that it has.</p>
					<div>
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					<div class="team-members">
						<a href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a4.jpg"></a> <a href="teams_board.html#"><img
							alt="member" class="img-circle" src="img/a5.jpg"></a> <a
							href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a6.jpg"></a> <a href="teams_board.html#"><img
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<h4>Info about Design Team</h4>
					<p>Uncover many web sites still in their infancy. Various versions
		...
		<div class="col-lg-4">
			<div class="ibox">
				...
				<div class="ibox-content">
					<div class="team-members">
						<a href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a8.jpg"></a> <a href="teams_board.html#"><img
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<h4>Info about Design Team</h4>
					<p>Internet tend to repeat predefined chunks as necessary, making
						this the first true generator on the Internet. It uses a
						dictionary of over 200 Latin.</p>
					<div>
						<span>Status of current project:</span>
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<p>Many desktop publishing packages and web page editors now use
						Lorem Ipsum as their. ometimes by accident, sometimes on purpose
		...
		<div class="col-lg-4">
				...
				<div class="ibox-content">
					<div class="team-members">
						<a href="teams_board.html#"><img alt="member" class="img-circle"
							...
							alt="member" class="img-circle" src="img/a4.jpg"></a> <a
							href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a7.jpg"></a> <a href="teams_board.html#"><img
							alt="member" class="img-circle" src="img/a2.jpg"></a>
					</div>
					<h4>Info about Design Team</h4>
					<p>Very popular during the Renaissance. The first line of Lorem
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					<div class="team-members">
						<a href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a2.jpg"></a> <a href="teams_board.html#"><img
							alt="member" class="img-circle" src="img/a3.jpg"></a> <a
							href="teams_board.html#"><img alt="member" class="img-circle"
							src="img/a8.jpg"></a> <a href="teams_board.html#"><img
					...
					<h4>Info about Design Team</h4>
					<p>Words which don't look even slightly believable. If you are
						going to use a passage of Lorem Ipsum, you need to be sure there
						isn't anything embarrassing hidden in.</p>
					<div>
						<span>Status of current project:</span>
